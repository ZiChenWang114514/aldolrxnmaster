...
NAME_MAP = {
    ...
    # t5chem_clf: removed — API incompatible, no predictions generated
    "chemprop": "Chemprop",
    ...
    "equireact": "EquiReact",
    # gcpnet: removed — protein-oriented, not adapted
    ...
    # Phase 11-B1: GFN2-xTB electronic descriptors added (87d = 24+10+12+35+6)
...
MODEL_ORDER = [
    ...
    "DistilBERT-Rxn", "RoBERTa-Rxn", "ChemBERTa-77M", "MolT5-base",
    "ChiENN-Product", "EquiReact",
