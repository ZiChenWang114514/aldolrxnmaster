...
from chiralaldol.steric_descriptors import STERIC_DESC_NAMES, find_reactive_center, compute_single_conformer_descriptors
...
def main():
    ...
    cond_df = pd.read_csv(PROJECT / "data" / "clean_v4" / "condition_features.csv")  # 44d
